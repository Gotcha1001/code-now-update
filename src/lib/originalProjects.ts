const originalProjects = [
  {
    href: "https://find-anthing.vercel.app/",
    title: "Project 20: Search anything",
    description:
      "Search for anything, local maids, best Italian restaurant in the neighbourhood, entertainment this week anything",
    shortDescription:
      "Search for anything, local maids, best Italian restaurant in the neighbourhood, entertainment this week anything",
  ...
  },
  {
    ...
    title: "Project 20: AI CV Generator",
    description:
      "Create multiple CV's for various jobs with AI commentary on your information and Image and Video displays, a digital annimation CV or a PDF download CV, this version has 4 different templates to choose from, centered side etc...",
    shortDescription:
      "Create multiple CV's for various jobs with AI commentary on your information and Image and Video displays, a digital annimation CV or a PDF download CV, this version has 4 different templates to choose from, centered side etc...",
    imageUrl: "/images/cv2.jpg",
    alt: "AI CV",
  },
  {
